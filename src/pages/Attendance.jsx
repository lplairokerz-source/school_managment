...
export default function Attendance() {
  ...
  const resource = RESOURCES['attendance']
    ...
    <div>
      ...
      <div className="card">
        <div className="grid">
          ...
          <FormField label="Date" name="date" value={{form['date'] || ''}} onChange={v => setField('date', v)} />
          <FormField label="Status" name="status" value={{form['status'] || ''}} onChange={v => setField('status', v)} />
        </div>
